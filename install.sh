...
BIRD_MONITOR_HEALTH_SNAPSHOT_INTERVAL_SECONDS=300
BIRD_MONITOR_CLIPPING_PEAK_THRESHOLD=0.98
BIRD_MONITOR_SILENCE_RMS_THRESHOLD=0.003
BIRD_MONITOR_SILENCE_ALERT_SECONDS=30
BIRD_MONITOR_LOW_DISK_FREE_BYTES=2147483648
BIRD_MONITOR_STATUS_HISTORY_DAYS=14
...
BIRD_MONITOR_DEFAULT_EVENT_LIMIT=200
BIRD_MONITOR_ACTIVE_NODE_WINDOW_HOURS=24
...
EOF
  ...
  grep -q '^BIRD_MONITOR_HEALTH_SNAPSHOT_INTERVAL_SECONDS=' "${ENV_FILE}" || echo "BIRD_MONITOR_HEALTH_SNAPSHOT_INTERVAL_SECONDS=300" >> "${ENV_FILE}"
  grep -q '^BIRD_MONITOR_CLIPPING_PEAK_THRESHOLD=' "${ENV_FILE}" || echo "BIRD_MONITOR_CLIPPING_PEAK_THRESHOLD=0.98" >> "${ENV_FILE}"
  grep -q '^BIRD_MONITOR_SILENCE_RMS_THRESHOLD=' "${ENV_FILE}" || echo "BIRD_MONITOR_SILENCE_RMS_THRESHOLD=0.003" >> "${ENV_FILE}"
  grep -q '^BIRD_MONITOR_SILENCE_ALERT_SECONDS=' "${ENV_FILE}" || echo "BIRD_MONITOR_SILENCE_ALERT_SECONDS=30" >> "${ENV_FILE}"
  grep -q '^BIRD_MONITOR_LOW_DISK_FREE_BYTES=' "${ENV_FILE}" || echo "BIRD_MONITOR_LOW_DISK_FREE_BYTES=2147483648" >> "${ENV_FILE}"
  grep -q '^BIRD_MONITOR_STATUS_HISTORY_DAYS=' "${ENV_FILE}" || echo "BIRD_MONITOR_STATUS_HISTORY_DAYS=14" >> "${ENV_FILE}"
  ...
  grep -q '^BIRD_MONITOR_DEFAULT_EVENT_LIMIT=' "${ENV_FILE}" || echo "BIRD_MONITOR_DEFAULT_EVENT_LIMIT=200" >> "${ENV_FILE}"
  grep -q '^BIRD_MONITOR_ACTIVE_NODE_WINDOW_HOURS=' "${ENV_FILE}" || echo "BIRD_MONITOR_ACTIVE_NODE_WINDOW_HOURS=24" >> "${ENV_FILE}"
