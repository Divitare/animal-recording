...
def create_app() -> Flask:
    app = Flask(__name__)
    app.config["APP_VARIANT"] = os.getenv("BIRD_MONITOR_APP_VARIANT", "v2-bird-node")
...
<html lang="en">
  ...
  <body>
    <main>
      <h1>V2 Bird Node</h1>
      <p>This is the new field-node scaffold.</p>
        ...
        return jsonify(
            {
                ...
                "service": {
                    "started": True,
                    "message": "V2 bird-node scaffold is installed.",
                },
            }
        )
