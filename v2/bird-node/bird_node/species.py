    ...
    def _finalize_predictions(
        ...
        *,
        ...
        self.last_analysis_details = {
            ...
            "analysis_scope": self.last_analysis_details.get("analysis_scope"),
...
def _collect_runtime_details(
    *,
    ...
    details: dict[str, object] = {
        ...
        "available": available,
        "reason": reason,
        "analysis_mode": "rolling-9-second-windows-every-3-seconds",
